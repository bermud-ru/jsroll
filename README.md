...
> (не по старым файлам в `docs/*.md` — часть из них описывала API, которого
> в коде никогда не было; актуальные `docs/router.md`, `docs/xhr.md`,
> `docs/tmpl.md`, `docs/event.md` уже исправлены и учтены здесь).
